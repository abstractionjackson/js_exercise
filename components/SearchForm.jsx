...
export default function SearchForm({ handleSearch }) {
    ...
    <form className="p-3" onSubmit={(e) => handleSubmit(e, name)}>
        <input required className="mr-3 p-1 shadow focus:outline-none focus:ring focus:ring-pink-300" type="text" id="name" onChange={handleChange} placeholder="Find a charity..." value={name} />
